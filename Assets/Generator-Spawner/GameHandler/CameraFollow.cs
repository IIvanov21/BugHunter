...
using System;
    ...
    public class CameraFollow : MonoBehaviour
    {
        ...
        private void HandleMovement()
        {
            ...
            if (distance > 0)
            {
            Vector3 newCameraPosition = transform.position + cameraMoveDir * distance * cameraMoveSpeed;
        ...
        private void HandleZoom()
        {
            ...
            float cameraZoomDifference;
                 ...
                 cameraZoomDifference = cameraZoom - myCamera.orthographicSize;

        
        
             float cameraZoomSpeed = 0.3f;

                myCamera.orthographicSize += cameraZoomDifference * cameraZoomSpeed;
